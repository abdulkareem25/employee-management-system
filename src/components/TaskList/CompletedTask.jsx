...
const CompletedTask = ({ task }) => {
    return (
        <div className='h-72 w-72 p-5 bg-yellow-500 rounded-2xl shrink-0 flex justify-between flex-col'>
            ...
            <div className="btns flex justify-center">
                <button className='px-5 py-2 bg-gray-500 rounded-full text-white font-semibold cursor-not-allowed'>Completed</button>
            </div>
        </div>
    )
}
